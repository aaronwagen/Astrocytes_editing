...
- This current repository contains the analysis of RNA editing in the cell culture models, as well as in a [published dataset](https://link.springer.com/article/10.1007/s00401-021-02343-x) of post-mortem brain samples. The results of this repository can be viewed interactively at
...
| --------- | --------------------------------------------------------------------------- |
| [docs](docs) | Contains all `.Rmd`s and their corresponding `.html`s describing analyses performed for this project. These can be view interactively at: [https://aaronwagen.github.io/Astrocytes_editing/](https://aaronwagen.github.io/Astrocytes_editing/)|
