...
Building on the IPSC cell astrocytes and astro-neuronal co-cultures showing increased anti-viral inflammatory markers and RNA editing in response to alpha-synuclein oligomers, we explored whether similar processes were occuring in vivo in PD brains.
...
```{r, eval = F}
ggsave(ewce_figure,
        file = str_c(args$output_folder, "/brain/brain_ewce_figure_top50_cf_pdbrain.png"),
        device = "png",
        dpi = 300,
        units = "cm",
        width = 12,
...
ggsave(ewce_figure,
        file = str_c(args$output_folder, "/brain/brain_ewce_figure_top50_cf_pdbrain.pdf"),
        device = "pdf",
        dpi = 300,
        units = "cm",
        width = 12,
